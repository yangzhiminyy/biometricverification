"""
Dataset manager for fingerprint modality (placeholder).
"""
...
class FingerprintDatasetManager(DatasetManager):
    """Persist raw fingerprint images to disk."""
    ...
    def _try_decode_data(self, sample: str) -> "FingerprintDatasetManager.DecodedData | None":
